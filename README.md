xray 跟新到1.6.5以及之后版本增加了wireguar协议的出口配置，但是体积增加了1M多，所以已经是低内存设备不友好了，
所以这里更新到现在仍旧是测试版的1.6.4版本的xray，虽然新的vision从1.6.2到1.6.5都没有解决使用上的问题，但是
1.6.4解决了xtls+vlesss的使用utls库的问题，这对于更新来说足够了！
